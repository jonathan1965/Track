          ...
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row align-items-center">
              <div class="col-xl-11 col-12 mb-4 mb-xl-0">
                ...
                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Create New Service</button>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;"><!-- <a href="#"><i class="fas fa-trash text-danger text-center"></i></a> -->
                  <button class="btn btn-primary-outline" data-myname="{{$service->name}}" data-catid={{$service->id}} data-toggle="modal" data-target="#edit"><i class="fa fa-edit text-success"></i></button>
                  /
                  <button class="btn btn-primary-outline" data-catid={{$service->id}} data-toggle="modal" data-target="#delete"><i class="fa fa-trash text-danger"></i></button>
                </td>
            </tr>
            @endforeach
        </tbody>
