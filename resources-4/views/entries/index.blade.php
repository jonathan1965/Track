...
@extends('layouts.app')
@section('content')
		<section style="padding-left: 10px; padding-top: 80px; background: #EEEEEE; >
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <tbody><tr>
                <td> Filter Data by Task Date</td>
                  ...
                  <td>
                    ...
                    <input type="text" id="min" name="min" class="form-control form-control-sm min">
                  </td>
                  </div>
                </div>
                  <td style="font-size: 175%;"><i class="fa fa-calendar text-primary" aria-hidden="true"></i></td>
                  <td><input type="text" id="max" name="max" class="form-control form-control-sm min"></td>
        </tr>
</tbody>
</table>
  ...
  <table id="examples" class="container table table-striped table-bordered" style="width:100%  padding-bottom: 25px; ">
    <thead>
        <tr>
          <th >S.No</th>
          <th >INV.No</th>
    ...
    <tbody>
      @foreach($entries as $entry)
        <tr>
          <td style="width: 50px;">{{$entry->id}}</td>
