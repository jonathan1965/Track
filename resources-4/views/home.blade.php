  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h2>You have:</h2>
      <h5><b>{{$expiredReminders}} </b> expired reminders</h5>
      
      <h5><b>{{$remindersDueToday}} </b> reminders due today</h5>
      <h5><b>{{$remindersDueThisWeek}}</b>  reminders due week</h5>
      <h5><b>{{$remindersDueThisMonth}}</b>  reminders due month</h5>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
