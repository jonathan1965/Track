	      ...
	      <div class="modal-body">
           ...
           <div  class="col-7">
            ...
            <div class="form-group">
              ...
              <input type="text" id="location" style="width: 250px" placeholder="Enter a location" name="location" />
            </div>
            <div class="form-group">
              <label for="title"><i class="fa fa-file text-primary"></i> Invoice Image</label>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><!-- <a href="#"><i class="fas fa-trash text-danger text-center"></i></a> -->
                              <button class="btn btn-primary-outline" data-myvehicle="{{$entry->vehicle}}" data-myclient="{{$entry->client}}" data-myamount="{{$entry->amount}}" data-myservice="{{$entry->service}}" data-myservice_date="{{$entry->service_date}}" data-myodometer_reading="{{$entry->odometer_reading}}" data-myfuel="{{$entry->fuel}}" data-mylocation="{{$entry->location}}" data-mycomments="{{$entry->comments}}" data-mydriver="{{$entry->driver}}" data-catid={{$entry->id}} data-toggle="modal" data-target="#edit"><i class="fa fa-edit text-success"></i></button>
                              /
        ...
        <div class="modal-body">
           ...
           <div  class="col-7">
            ...
            <div class="form-group">
              ...
              <input type="text" id="location" style="width: 250px" placeholder="Enter a location" />
            </div>
            </div>
            </div>
            <div class="row">
