<nav class="navbar navbar-expand-md navbar-light">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <div class="container-fluid">
          <div class="row">
            <!-- sidebar -->
            <div class="col-xl-2 col-lg-1 col-md-3  fixed-top sidebarc">
              ...
              <ul class="navbar-nav flex-column mt-4">
                ...
                <li class="nav-item"><a href="/reminder" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-clock text-light fa-lg mr-3"></i>Reminders</a></li>
                ...
                <li class="nav-item"><a href="/task" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-tasks text-light fa-lg mr-3"></i>Tasks</a></li>
                <li class="nav-item"><a href="/user" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-users text-light fa-lg mr-3"></i>Users</a></li>
