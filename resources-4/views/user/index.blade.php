      ...
      <table class="display" id="example">
          ...
          <tbody>
                ...
                <td> 
                  ...
                  <button type="button" class="btn btn-primary-outline  btn-sm" data-myname="{{$user->name}}" data-usertp={{$user->usertype}}  data-user_id={{$user->id}}  data-toggle="modal" data-target="#edit">
