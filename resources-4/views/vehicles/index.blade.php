          ...
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row align-items-center">
              <div class="col-xl-11 col-12 mb-4 mb-xl-0">
                ...
                <button type="button" class="btn btn-info btn-gb" data-toggle="modal" data-target="#myModal">Create New Vehicle</button>
      ...
      <form action="{{route('vehicles.store')}}" method="post">
	      ...
	      <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="file" class="form-control" name="file" id="plate">
            </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;"><!-- <a href="#"><i class="fas fa-trash text-danger text-center"></i></a> -->
                  <button class="btn btn-primary-outline" data-myclient="{{$vehicle->client}}" data-mytype="{{$vehicle->type}}" data-mymake="{{$vehicle->make}}" data-mymodel="{{$vehicle->model}}" data-myplate="{{$vehicle->plate}}" data-catid={{$vehicle->id}} data-toggle="modal" data-target="#edit"><i class="fa fa-edit text-success"></i></button>
                  /
                  <button class="btn btn-primary-outline" data-catid={{$vehicle->id}} data-toggle="modal" data-target="#delete"><i class="fa fa-trash text-danger"></i></button>
                </td>
            </tr>
            @endforeach
        </tbody>
