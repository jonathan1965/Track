          ...
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row align-items-center">
              <div class="col-xl-11 col-12 mb-4 mb-xl-0">
                <h3 class="text-muted text-center mb-3">Services</h3>
                <button type="button" class="btn btn-primary btn-gb" data-toggle="modal" data-target="#myModal">Create New Service</button>
      ...
      <form action="{{route('services.store')}}" method="post">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="btn btn-primary">Save</button>
                ...
                <table id="" class="table  table-striped table-bordered  display" style="width:100%; padding-top: 20px;">
        <thead>
            <tr>
               <th>Service</th>
               <th>Description</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center; width:10%;"><!-- <a href="#"><i class="fas fa-trash text-danger text-center"></i></a> -->
                  <button style=" width:40%;" class=" btn-primary-outline" class="btn btn-primary-outline" data-myname="{{$service->name}}" data-mydescription="{{$service->description}}" data-catid={{$service->id}} data-toggle="modal" data-target="#edit"><i class="fa fa-edit text-success"></i></button>
                  
                  <button style=" width:40%;" class=" btn-primary-outline" class="btn btn-primary-outline" data-catid={{$service->id}} data-toggle="modal" data-target="#delete"><i class="fa fa-trash text-danger"></i></button>
                </td>
            </tr>
            @endforeach
        </tbody>
    ...
    <div class="modal-content">
      ...
      <form action="{{route('services.update','test')}}" method="post">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              <label for="title"><i class="fa fa-star text-primary"></i> Name</label>
              <input type="text" class="form-control" name="name" id="name">
            </div>
            <div class="form-group">
              <label for="title"><i class="fa fa-star text-primary"></i>Description</label>
